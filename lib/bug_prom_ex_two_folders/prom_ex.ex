defmodule BugPromExTwoFolders.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule BugPromExTwoFoldersWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :bug_prom_ex_two_folders

       ...

       plug PromEx.Plug, prom_ex_module: BugPromExTwoFolders.PromEx
  ...
  use PromEx, otp_app: :bug_prom_ex_two_folders
